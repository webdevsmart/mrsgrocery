	...
	<div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
		...
		<div id="content" class="<?php echo $class; ?> ms-account-dashboard"><?php echo $content_top; ?>
			<div class="mm_dashboard ms-seller-settings">
				<h1 class="heading-title"><i class="fa fa-tachometer"></i><?php echo $ms_account_settings ;?></h1>

				<ul id="tabs" class="nav nav-tabs htabs topbar">
				...
				<div class="tabs-content">
					<div id="tab-general" class="tab-pane tab-content active">
						<form id="ms-sellersettings" class="ms-form form-horizontal">
							...
							<div class="buttons">
								<div class="pull-right">
									<a class="btn button btn-primary" id="ms-submit-button"><span><?php echo $ms_button_save; ?></span></a>
								</div>
							</div>
						</form>
					</div>

					<div id="tab-payment-gateways" class="tab-pane tab-content">
						<ul id="tabs" class="nav nav-tabs htabs pg-topbar">
						...
						<div class="tabs-content ms-pg-content">
							<?php foreach($payment_gateways as $payment_gateway) { ?>
								<div id="tab-<?php echo $payment_gateway['code']; ?>" class="tab-pane tab-content <?php echo reset($payment_gateways) == $payment_gateway ? 'active' : ''; ?>">
					...
					<div id="tab-seller-shipping" class="tab-pane tab-content">
						<div class="alert alert-danger warning hidden" id="ssm-error-holder"></div>
							...
							<form id="ms-seller-shipping" class="ms-form form-horizontal">
								<fieldset class="control-inline">
									...
									<div class="panel panel-default table-responsive">
										...
										<div class="col-sm-12">
											<div class="pull-left">
												<a class="btn button btn-default ffClone"><?php echo $ms_account_settings_shipping_add; ?></a>
											</div>
											<div class="pull-right">
												<a class="btn button btn-primary" id="ms-ssm-submit"><span><?php echo $ms_button_save; ?></span></a>
											</div>
										</div>
									</div>
								</fieldset>
