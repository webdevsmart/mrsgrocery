<?php echo $header; ?>
<div id="container" class="container register-seller">
  <ul class="breadcrumb">
      ...
      <form id="seller-form" class="form-horizontal">
        ...
        <div class="buttons">
          <div class="pull-right">
            <a class="btn button btn-primary ms-spinner" id="ms-submit-button" value="<?php echo $button_continue; ?>"><span><?php echo $button_continue; ?></span></a>
          </div>
        </div>
      </form>
