	...
	<div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
		...
		<div id="content" class="<?php echo $class; ?> ms-account-dashboard seller-dashboard"><?php echo $content_top; ?>
			<div class="mm_dashboard col-sm-12">
				<h1 class="heading-title"><i class="fa fa-tachometer"></i><?php echo $ms_account_dashboard ;?></h1>

				<div class="row">
					<div class="xl-20 md-50 col-sm-6">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="ms-dashboard-widget chart">
							<div class="heading">
								<h3 class="secondary-title"><?php echo $ms_account_dashboard_sales_analytics; ?></h3>
							</div>
							<div class="body">
				...
				<div class="row">
					<div class="xl-50 md-50 col-sm-12">
						<div class="ms-dashboard-widget chart">
							<div class="heading">
								<h3 class="secondary-title"><?php echo $ms_account_dashboard_top_selling_products; ?></h3>
							</div>
							<div class="body">
					...
					<div class="xl-50 md-50 col-sm-12">
						<div class="ms-dashboard-widget chart">
							<div class="heading">
								<h3 class="secondary-title"><?php echo $ms_account_dashboard_top_viewed_products; ?></h3>
							</div>
							<div class="body">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="ms-dashboard-widget list">
							<div class="heading">
								<h3 class="secondary-title"><?php echo $ms_account_dashboard_last_orders; ?></h3>
							</div>
				...
				<?php if ($this->config->get('msconf_reviews_enable')) { ?>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="ms-dashboard-widget list">
								<div class="heading">
									<h3 class="secondary-title"><?php echo $ms_account_dashboard_last_reviews; ?></h3>
								</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="ms-dashboard-widget list">
							<div class="heading">
								<h3 class="secondary-title"><?php echo $ms_account_dashboard_last_messages; ?></h3>
							</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="ms-dashboard-widget list">
							<div class="heading">
								<h3 class="secondary-title"><?php echo $ms_account_dashboard_last_invoices; ?></h3>
							</div>
