...
<div id="container" class="container">
    ...
    <div class="alert alert-success success"><?php echo $import_result; ?></div>
    <?php } ?>

	<?php if (isset($product_number_limit_exceeded) && $product_number_limit_exceeded) { ?>
	<div class="alert alert-warning information"><i class="fa fa-check-exclamation-circle"></i> <?php echo $product_number_limit_exceeded; ?></div>
	<?php } ?>
	...
	<div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
		...
		<div id="content" class="<?php echo $class; ?> ms-account-dashboard"><?php echo $content_top; ?>
			<div class="mm_dashboard">
				<h1 class="heading-title"><i class="fa fa-briefcase"></i><?php echo $ms_account_products_heading; ?></h1>
                ...
                <div class="dropdown pull-right">
                    <button class="btn button btn-default dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-cog" aria-hidden="true"></i>
				...
				<?php if(!isset($product_number_limit_exceeded)) { ?>
					<a href="<?php echo $this->url->link('seller/account-product/create', '', 'SSL'); ?>" class="btn button btn-primary" id="ms-submit-button"><span><?php echo $ms_account_newproduct; ?></span></a>
				<?php } ?>
