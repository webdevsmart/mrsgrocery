  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		<button type="button" class="btn button btn-default" data-dismiss="modal"><?php echo $ms_sellercontact_close; ?></button>
		<button type="button" class="btn button btn-primary" id="sendMessage"><?php echo $ms_sellercontact_send; ?></button>
	  </div>
	</div>
  </div>
</div>