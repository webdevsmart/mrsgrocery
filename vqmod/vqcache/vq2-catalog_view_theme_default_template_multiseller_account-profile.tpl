...
<div id="container" class="container account-seller-profile">
    <ul class="breadcrumb">
	...
	<?php } ?>
	<div class="alert alert-danger warning warning main error"></div>
		...
		<div id="content" class="<?php echo $class; ?> ms-account-dashboard"><?php echo $content_top; ?>
			<div class="mm_dashboard">
				<?php if (isset($statustext) && ($statustext)) { ?>
					<div class="alert alert-<?php echo $statusclass; ?> <?php echo $statusclass === 'success' ? 'success' : ''; ?>"><?php echo $statustext; ?></div>
				<?php } ?>
											...
											<div id="group<?php echo $seller_group['seller_group_id']; ?>" class="change_group_block">
												<div class="mm_dashboard_block">
													...
													<div class="text-center">
														<span data-group_id="<?php echo $seller_group['seller_group_id']; ?>" class="btn button btn-primary select_plan"><?php echo $ms_account_group_select_plan ;?></span>
													</div>
												</div>
											</div>
										</div>
				...
				<div class="buttons">
					<?php if ($seller['ms.seller_status'] != MsSeller::STATUS_DISABLED && $seller['ms.seller_status'] != MsSeller::STATUS_DELETED) { ?>
						<div class="pull-right">
							<a class="btn button btn-primary ms-spinner" id="ms-submit-button">
